...
export class ConfigSanitizer {
     ...
     * - Contains eval/Function/require calls (except imports)
    ...
    static validateJavaScript(content: string): string {
        ...
        // Note: We can't fully parse JS without a full parser
        // But we've already checked for dangerous patterns above
